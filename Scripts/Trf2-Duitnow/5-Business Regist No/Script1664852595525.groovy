...
WebUI.setText(findTestObject('trf/duitnow/popup bisnes/input_Business Registration Number_proxyId'), findTestData('Transfer').getValue(2, 22))

WebUI.setText(findTestObject('trf/duitnow/popup bisnes/input_Transfer Amount_amount'), findTestData('Transfer').getValue(3, 22))

WebUI.setText(findTestObject('trf/duitnow/popup bisnes/input_concat(Recipient  s Reference)_transferPurpose'), findTestData('Transfer').getValue(4, 22))
...
WebUI.callTestCase(findTestCase('TAC'), [('TACmessage'):findTestData('Transfer').getValue(5, 22)], FailureHandling.CONTINUE_ON_FAILURE)
