...
a = WebUI.getText(findTestObject('custom/currency calc1', [('text') : findTestData('Transfer').getValue(6, 64)])).replaceAll(
    ' ', '')

b = WebUI.getText(findTestObject('custom/currency calc2', [('text') : findTestData('Transfer').getValue(6, 64)])).replaceAll(
    ' ', '')

CustomKeywords.'com.CurrencyCalc.RMtoOthers'(a, b)

WebUI.click(findTestObject('custom/Button based on OT type', [('text') : findTestData('Transfer').getValue(6, 64)]))
...
WebUI.setText(findTestObject('OT/WU-Sender Details/textarea_address line1'), findTestData('Transfer').getValue(6, 67))

WebUI.setText(findTestObject('OT/WU-Sender Details/textarea_address line2'), findTestData('Transfer').getValue(6, 68))
...
WebUI.setText(findTestObject('OT/WU-Sender Details/textarea_Temporary Address Line 2 (Optional)_senderTempAddrLine2'), findTestData(
        'Transfer').getValue(6, 71))

WebUI.setText(findTestObject('OT/WU-Sender Details/input_Postcode_senderTempAddrPostCode'), findTestData('Transfer').getValue(
        6, 72))

WebUI.setText(findTestObject('OT/WU-Sender Details/input_City_senderTempAddrCity'), findTestData('Transfer').getValue(6, 
        73))
...
WebUI.setText(findTestObject('OT/WU-Sender Details/input_ID Number_senderIdNumber'), findTestData('Transfer').getValue(6, 
        76))

//date of isuee here (77,78)
if (WebUI.verifyElementPresent(findTestObject('OT/WU-Sender Details/Page_Notification/input_ID Date of Issue (DDMMYYYY)_senderIdDateOfIssue'), 
    ...
    WebUI.setText(findTestObject('OT/WU-Sender Details/Page_Notification/input_ID Date of Issue (DDMMYYYY)_senderIdDateOfIssue'), 
        findTestData('Transfer').getValue(6, 77))
    ...
    WebUI.setText(findTestObject('OT/WU-Sender Details/Page_Notification/input_ID Date of Expiry (DDMMYYYY)_senderIdDateOfExpiry'), 
        findTestData('Transfer').getValue(6, 78))
}
...
if (WebUI.verifyTextPresent('Employment Position Level', false, FailureHandling.OPTIONAL)) {
    ...
    WebUI.click(findTestObject('OT/WU-Sender Details/Page_Notification/span_Entry Level -emp pos', [('id') : findTestData(
                    'Transfer').getValue(6, 81)]))
}

WebUI.click(findTestObject('OT/WU-Sender Details/button_Please Select Rel to Ben'))

WebUI.click(findTestObject('OT/WU-Sender Details/span_Family -Rel to Ben', [('id') : findTestData('Transfer').getValue(6, 
                82)]))
...
WebUI.click(findTestObject('OT/WU-Sender Details/span_SalaryIncome -SOF', [('id') : findTestData('Transfer').getValue(6, 
                84)]))
...
WebUI.setText(findTestObject('OT/WU-recipient details/input_Last Name_benLastName'), findTestData('Transfer').getValue(6, 
        90))
...
WebUI.setText(findTestObject('OT/WU-recipient details/input_Receiver Country  Code_RenderSearchableDropdown---paymentInput---21ojH'), 
    'Singapore', FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('OT/WU-recipient details/div_Afghanistan -reciever country'))
...
WebUI.setText(findTestObject('OT/WU-recipient details/input_State_benState'), findTestData('Transfer').getValue(6, 97))
...
WebUI.setText(findTestObject('OT/WU-recipient details/input_Country_RenderSearchableDropdown---paymentInput---21ojH'), 'Singapore', 
    FailureHandling.CONTINUE_ON_FAILURE)
